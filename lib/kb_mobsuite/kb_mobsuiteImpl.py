...
class kb_mobsuite:
    ...
    ######################################### noqa
    VERSION = "0.0.1"
    GIT_URL = "https://github.com/Cyrus-Shahnam/kb_mobsuite.git"
    GIT_COMMIT_HASH = "1444b4d9b2f546c363e19127be692429cb9403b5"
...
""")
    ...
    def run_mob_recon_app(self, ctx, params):
        """
        :param params: instance of type "MOBReconParams" -> structure:
           parameter "workspace_name" of type "workspace_name", parameter
           "assembly_ref" of type "data_obj_ref", parameter "sample_id" of
           String, parameter "user_filter_fasta_ref" of type "data_obj_ref",
           parameter "closed_genomes_fasta_ref" of type "data_obj_ref",
           parameter "threads" of Long, parameter "emit_plasmid_assembly" of
           Long
        :returns: instance of type "MOBReconResult" -> structure: parameter
           "report_name" of String, parameter "report_ref" of String,
           parameter "plasmid_assembly_ref" of type "data_obj_ref"
        """
        ...
        if not isinstance(returnVal, dict):
            raise ValueError('Method run_mob_recon_app return value ' +
    ...
    def run_mob_typer_app(self, ctx, params):
        """
        :param params: instance of type "MOBTyperParams" -> structure:
           parameter "workspace_name" of type "workspace_name", parameter
           "fasta_ref" of type "data_obj_ref", parameter "sample_id" of
           String, parameter "multi" of Long, parameter "threads" of Long,
           parameter "emit_mge_report" of Long
        :returns: instance of type "MOBTyperResult" -> structure: parameter
           "report_name" of String, parameter "report_ref" of String
        """
        # ctx is the context object
        # return variables are: returnVal
        ...
        # At some point might do deeper type checking...
        if not isinstance(returnVal, dict):
            raise ValueError('Method run_mob_typer_app return value ' +
                             'returnVal is not type dict as required.')
        # return the results
        return [returnVal]
    ...
    def run_mob_cluster_app(self, ctx, params):
        """
        :param params: instance of type "MOBClusterParams" -> structure:
           parameter "workspace_name" of type "workspace_name", parameter
           "mode" of String, parameter "plasmids_assembly_ref" of type
           "data_obj_ref", parameter "mobtyper_report_staging_path" of
           String, parameter "host_taxonomy_staging_path" of String,
           parameter "existing_clusters_staging_path" of String, parameter
           "existing_sequences_fasta_staging_path" of String, parameter
           "sample_id" of String
        :returns: instance of type "MOBClusterResult" -> structure: parameter
           "report_name" of String, parameter "report_ref" of String
        """
        # ctx is the context object
        # return variables are: returnVal
        ...
        # At some point might do deeper type checking...
        if not isinstance(returnVal, dict):
            raise ValueError('Method run_mob_cluster_app return value ' +
                             'returnVal is not type dict as required.')
        # return the results
        return [returnVal]
    ...
    def run_mob_recon_batch_app(self, ctx, params):
        """
        :param params: instance of type "MOBReconBatchParams" -> structure:
           parameter "workspace_name" of type "workspace_name", parameter
           "assembly_set_ref" of type "data_obj_ref", parameter
           "assembly_refs" of type "AssemblyRefList" -> list of type
           "data_obj_ref", parameter "sample_id_prefix" of String, parameter
           "user_filter_fasta_ref" of type "data_obj_ref", parameter
           "closed_genomes_fasta_ref" of type "data_obj_ref", parameter
           "threads" of Long, parameter "emit_plasmid_assembly" of Long
        :returns: instance of type "MOBReconBatchResult" -> structure:
           parameter "report_name" of String, parameter "report_ref" of
           String, parameter "plasmid_assembly_refs" of type
           "AssemblyRefList" -> list of type "data_obj_ref"
        """
        # ctx is the context object
        # return variables are: returnVal
        ...
        # At some point might do deeper type checking...
        if not isinstance(returnVal, dict):
            raise ValueError('Method run_mob_recon_batch_app return value ' +
                             'returnVal is not type dict as required.')
        # return the results
        return [returnVal]
    def status(self, ctx):
